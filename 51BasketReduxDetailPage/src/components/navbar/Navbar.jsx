...
export default function Navbar() {
  ...
  let count = basket.reduce((acc, propduct) => acc + propduct.count, 0)
      ...
      <MenuItem>
        ...
        <IconButton size="large" aria-label="show 4 new mails" color="inherit">
          <Badge badgeContent={4} color="error">
            <Link to='/wishlist'> <FavoriteIcon style={{backgroundColor:"white"}} /></Link>
        ...
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            <IconButton size="large"  aria-label="show 4 new mails" color="inherit">
              <Badge  color="error">
                {
                  user ?(  <Link  to='/wishlist'> < FavoriteIcon style={{color:"white"}}/>
                </Link>):( <Link to='/login'> < FavoriteIcon style={{color:"white"}}/>
                  </Link>)
                }
            ...
            > 
              <Badge  color="error">  
               ...
               {/* <LocalGroceryStoreSharpIcon /> </Link> */}
                {
                  user ?(  <Link  to='/basket'>    <Badge badgeContent={count} color="error">
                    <LocalGroceryStoreSharpIcon  style={{color:"white"}}/>
                  </Badge>
                </Link>):( <Link to='/login'> < LocalGroceryStoreSharpIcon style={{color:"white"}}/>
                  </Link>)
                }
              </Badge>
            </IconButton>
